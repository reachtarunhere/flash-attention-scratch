...
def _flash_attention_forward_gqa_kernel(
    ...
    V_ptr,
    O_ptr,
    M_ptr, # this is acutally L in the flash attention paper but I am trying to keep consistent with assignment 8 starter code
    ...
    m_ptrs = (
        ...
        + q_offsets * m_stride_s                                                
    )
    m_to_store = m_i + tl.log(l_i + 1e-6)                      
    tl.store(m_ptrs, m_to_store, mask=q_offsets < SEQ_LEN)
